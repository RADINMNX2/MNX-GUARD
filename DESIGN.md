# MNX GUARD Android design contract

## Intent

MNX GUARD should feel like a calm, trustworthy dark Android system tool. The home screen is a
...
This is MNX GUARD's own visual system. Any third-party app is an interaction reference only;
